...
export type SerializedDeck = Array<SerializedCard>;
export type SerializedNullableDeck = Array<SerializedCard|null>;

const coreDeckDeserialize = validatedDelta((input: SerializedNullableDeck, deck: Deck<Card|null>|null) => {
...
export class Deck<T> extends Array<T> {
	...
	static deserialize(input: SerializedNullableDeck, deck: Deck<Card|null>) {
